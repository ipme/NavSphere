...
const JsonEditor = dynamic(() => import("@/components/ui/json-editor").then(mod => mod.JsonEditor), {
  ssr: false,
  loading: () => <div className="h-[500px] border rounded-lg bg-muted/10 animate-pulse" />
})
